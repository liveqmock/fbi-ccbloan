...
public class CcbLoanConst {
    ...
    /** 推介客户顺序号*/
    public static final String PROMONTIONNO = "PROMONTIONNO";
    /** 营销客户经理ID*/
    public static final String PROMMGR_ID = "PROMMGR_ID";

    /** 缴款人账户序号 2013-11-06 linyong*/
    public static final String ACCTID                  = "ACCT";
    /**
     * 业务类型，操作日志表专用
     */
    ...
    /** 综合查询统计四 */
    public static final String MISC_RPT_MODEL_04        = "miscRptModel04";
    /** 权证入库统计表 */
    public static final String MISC_RPT_PAPER_STAT      = "paperStatModel";

    /** 综合查询 签约放款未回证统计表一 */
    public static final String NORTN_RPT_MODEL_01        = "noRtnRptModel01";
    /** 综合查询 签约放款未回证统计表二 */
    public static final String NORTN_RPT_MODEL_02        = "noRtnRptModel02";
    /** 综合查询 签约放款未回证统计表三 */
    public static final String NORTN_RPT_MODEL_03        = "noRtnRptModel03";
    ...
    /** 快递资料已签收 20A */
    public static final String MORT_FLOW_DATA_SIGNIN    = "20A";

    /** 已快递回证 21 */
    public static final String MORT_FLOW_RETURN          = "21";
    /** 权证已签收 21A */
    public static final String MORT_FLOW_PAPER_SIGNIN    = "21A";
    ...
    /** 营销信息录入 */
    public static final String BUSINODE_170             = "170";
    /** 营销信息审核 */
    public static final String BUSINODE_180             = "180";
    /** 个贷信用评定  */
    public static final String BUSINODE_190             = "190";
