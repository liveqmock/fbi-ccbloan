<!--
/*********************************************************************
* 功能描述: 买单工资查询统计项目表12---加权处理  zr 20150104
* 作 者: leonwoo
* 开发日期: 2010/01/16
* 修 改 人:
* 修改日期:
...
<title></title>
<script language="javascript" src="payBillListOrg2.js"></script>
...
<%
    ...
    String ods_src_dt="";
    try {
        RecordSet rs = dc.executeQuery("select max(t.ods_src_dt) as ods_src_dt from LN_LOANAPPLY t ");
        if  (rs != null && rs.next()) {
            ods_src_dt =  rs.getString("ods_src_dt");
        }
    } finally {
        cm.release();
    }
...
<div class="queryPanalDiv">
  ...
  <legend>加权利率浮动数据统计</legend>
  <form id="queryForm" name="queryForm">
    <div class="queryDiv">
        <input type="hidden" name="ods_src_dt" value="<%=ods_src_dt%>" >
