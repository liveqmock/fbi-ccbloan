...
<head>
    ...
    <title></title>
    <script language="javascript" src="payBillList18.js"></script>
                ...
                <table>
                    <tr>
                        <td colspan="8" nowrap="nowrap" align="right"><input name="expExcel"
                                                                             ...
                                                                             onClick="loanTab_expExcel_click(1)"
                                                                             value="全部导出">
                            <input name="expExcel"
                                   class="buttonGrooveDisableExcel"
                                   type="button" id="button2"
                                   onClick="loanTab_expExcel_click(2)"
                                   value="仅大综合性支行">
                            <input name="expExcel"
                                   class="buttonGrooveDisableExcel"
                                   type="button" id="button3"
                                   onClick="loanTab_expExcel_click(3)"
                                   value="仅小机构">
