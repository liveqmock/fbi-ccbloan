...
<!--
/*********************************************************************
* 功能描述: 贷款超审批时效明细查询,统计超审批3个月时效数据。
* 查询条件如下：
* 见证放款、超审批时效三个月，未登记，不含已撤卷数据。
* 作 者:  zr
* 开发日期:  20121110
* 修 改 人:
* 修改日期:
...
<%
    ...
    // 贷款信息
    dbGrid.setField("申请顺序号", "text", "8", "loanid", "true", "0");
    dbGrid.setField("审批日期", "text", "8", "apprdate", "true", "0");
    ...
    dbGrid.setWhereStr(" and a.loanid = b.loanid  --贷款申请号\n" +
...
<fieldset style="padding-top:-5px;padding-bottom:0px;margin-top:0px">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            <tr>
                <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款超审批时效日期(<=)</td>
