...
function saveClick() {
    ...
    if (operation == "add") {
        retxml = createExecuteform(editForm, "insert", "com.ccb.acctmng.AcctInfoAction", "add");
    } else if (operation == "edit") {
        retxml = createExecuteform(editForm, "update", "com.ccb.acctmng.AcctInfoAction", "edit");
    }
