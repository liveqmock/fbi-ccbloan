...
<head>
    ...
    <title></title>
    <script language="javascript" src="acctInfoMng.js"></script>
...
//    dbGrid.setField("抵押人姓名", "center", "5", "apptName", "true", "0");
    ...
    if (menuAction.equals(CcbLoanConst.MENU_SELECT)) {
        ...
        dbGrid.setbuttons("编辑账户=editRecord,缴费报销=batchEdit,通知书打印=filePrint,汇总导出=allExport,moveFirst,prevPage,nextPage,moveLast");
    }
%>
