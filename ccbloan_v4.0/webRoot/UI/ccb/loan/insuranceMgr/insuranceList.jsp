...
<head>
    ...
    <script language="javascript" src="insuranceList.js"></script>
...
<%
    ...
    String sql = "select " +
            ...
            + " a.nbxh,c.attendflag "
            + " from ln_mortinfo b left join ln_loanapply a on a.loanid=b.loanid " +
            "   left join ln_insurance c on b.mortid=c.mortid and b.loanid = c.loanid "
            + "   where  1=1 and (c.insurancests='0' or c.insurancests is null) ";
    ...
    dbGrid.setField("是否办理保险","center","10","attendflag","true","0");
//    dbGrid.setWhereStr(" order by b.mortdate desc,a.cust_py asc ");
    dbGrid.setWhereStr(" and a.bankid in(select deptid from ptdept start with deptid='" + omgr.getOperator().getDeptid() + "' connect by prior deptid=parentdeptid) order by c.insurancests,b.mortecentercd, a.bankid, b.mortid ");

    dbGrid.setpagesize(50);
    dbGrid.setdataPilotID("datapilot");
    dbGrid.setbuttons("导出Excel=excel,编辑保单=insuranceEdit,moveFirst,prevPage,nextPage,moveLast");
%>
