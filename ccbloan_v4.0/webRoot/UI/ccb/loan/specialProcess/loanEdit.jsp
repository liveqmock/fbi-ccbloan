...
<fieldset style="padding: 15px">
    ...
    <table width="100%" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td width="30%" class="data_input"><input type="text" id="loanID" name="loanID" value=""
                                                                  intLength="24"
                                                                  style="width:36.8% " isNull="false"><span
                    class="red_star">*</span>
            </td>
<%--
            <td width="15%" nowrap="nowrap" class="lbl_right_padding">营销客户序号</td>
            <td width="30%" class="data_input">
                <input type="text" id="PROMCUST_NO" name="PROMCUST_NO" value="<%=promcust_no%>" readonly="true" intLength="24"
                       style="width:85% "><input style="width:5% " type="button" title="取消" value="取消" onclick="document.getElementById('PROMCUST_NO').value='';"/>
            </td>
--%>
        </tr>
        <tr>
            <td width="15%" nowrap="nowrap" class="lbl_right_padding">贷款人姓名</td>
            <td width="35%" class="data_input"><input type="text" onblur="queryPromotionInfo()" id="CUST_NAME" name="CUST_NAME" style="width:90%"
