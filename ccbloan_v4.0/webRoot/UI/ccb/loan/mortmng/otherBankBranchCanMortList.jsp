...
<head>
    ...
    <script language="javascript" src="otherBankBranchCanMortList.js"></script>
...
<%
    ...
    dbGrid.setField("已申请可报抵押日期", "text", "12", "RPTMORTDATE", "true", "0");
    ...
    dbGrid.setbuttons("导出Excel=excel,查看贷款=loanQuery,查看抵押=query,可报登记申请=editRecord,批量申请=BatchEditRecord,不可报修改=editSendFlag,批量修改=BatchEditSendFlag,moveFirst,prevPage,nextPage,moveLast");
%>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            <tr>
                ...
                <td width="25%" align="right" nowrap="nowrap" class="data_input">
                    <div><input type="text" id="proj_no" name="proj_no"    style="width:34.2% "
                                onClick="queryCoopProjNo()"  readonly="readonly"  >
                    </div>
                </td>
                <td width="15%" nowrap="nowrap" class="lbl_right_padding">可报抵押标志</td>
                <td width="25%" nowrap="nowrap" class="data_input">
                    <%
                        ZtSelect zs = new ZtSelect("SENDFLAG", "SENDFLAG", "");
