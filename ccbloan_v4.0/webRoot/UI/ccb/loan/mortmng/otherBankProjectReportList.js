...
function loanTab_expExcel_click() {
    ...
    document.getElementById("queryForm").action = "otherBankProjectReport.jsp";
 ...
 *
 */
function loanTab_expExcelNo_click() {
    ...
    document.getElementById("queryForm").target = "_blank";
    document.getElementById("queryForm").action = "otherBankProjectReportNo.jsp";
    document.getElementById("queryForm").submit();
}