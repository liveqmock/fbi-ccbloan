...
<head>
    ...
    <script language="javascript" src="otherBankBranchCanMortEdit.js"></script>
</head>
            ...
            <table width="100%" class="title1" cellspacing="0">
                <tr>
                    <td align="center"><!--查询-->
                        ...
                        <%} else if (doType.equals("edit") || doType.equals("add") || doType.equals("apply")|| doType.equals("modify")) { %>
                        <!--增加，修改-->
