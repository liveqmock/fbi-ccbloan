...
<head>
    ...
    <script language="javascript" src="apptConfirmList.js"></script>
...
<%
    ...
    String sql = "select a.nbxh, b.mortecentercd, "
            ...
            + "     b.recVersion, b.FLOWSN, b.APPT_BIZ_CODE, (b.APPT_HDL_DATE||decode(b.APPT_HDL_TIME,'01','上午','下午')) APPT_HDL_DATE_TMP,  b.RELEASECONDCD, b.APPT_REMARK  "
...
*/
    ...
    dbGrid.setField("预约申请备注", "text", "30", "APPT_REMARK", "true", "0");
    ...
    dbGrid.setbuttons("查看贷款=loanQuery,查看抵押=query,抵押预约确认=batchSignin,抵押预约退回=batchSendback,moveFirst,prevPage,nextPage,moveLast");
%>
