...
<head>
    ...
    <script language="javascript" src="apptProcQry.js"></script>
...
<%
    ...
    String sql = "select a.nbxh, b.mortecentercd, "
            ...
            + "     b.recVersion, b.FLOWSN, b.APPT_CONFIRM_RESULT, b.APPT_DATE_CONFIRM,b.APPT_FEEDBACK_RESULT,b.RELEASECONDCD,  "
            + "     a.cust_open_dt, a.expiring_dt, b.chgpaperdate, b.appt_date_apply, "
            + "     b.APPT_REMARK,b.APPT_SENDBACK_REMARK,b.APPT_FEEDBACK_REMARK,b.boxid  "
            ...
            + "   and b.apptstatus is not null and b.apptstatus > '01' "
    ...
    dbGrid.setField("放款方式", "dropdown", "8", "RELEASECONDCD", "true", "RELEASECONDCD");
    dbGrid.setField("开户日期", "center", "8", "cust_open_dt", "true", "0");
    dbGrid.setField("到期日期", "center", "8", "expiring_dt", "true", "0");
    dbGrid.setField("借证领用日期", "center", "8", "chgpaperdate", "true", "0");
    dbGrid.setField("预约申请日期", "center", "8", "appt_date_apply", "true", "0");
    dbGrid.setField("预约申请备注", "text", "20", "APPT_REMARK", "true", "0");
    dbGrid.setField("预约确认(退回)备注", "text", "15", "APPT_SENDBACK_REMARK", "true", "0");
    dbGrid.setField("办理反馈备注", "text", "10", "APPT_FEEDBACK_REMARK", "true", "0");
    dbGrid.setField("柜号", "text", "10", "boxid", "true", "0");
...
<fieldset>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            ...
            <tr height="20">
                <td width="10%" nowrap="nowrap" class="lbl_right_padding">预约及办理状态</td>
                <td width="20%" nowrap="nowrap" class="data_input">
                    <%
                ...
                <td width="10%" nowrap="nowrap" class="lbl_right_padding">办理反馈结果</td>
                <td width="20%" nowrap="nowrap" class="data_input">
                    <%
