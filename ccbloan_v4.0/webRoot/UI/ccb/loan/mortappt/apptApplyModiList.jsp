...
<head>
    ...
    <script language="javascript" src="apptApplyModiList.js"></script>
...
<%
    ...
    String sql = "select a.nbxh, b.mortecentercd, "
            ...
            + "     b.recVersion, b.FLOWSN, b.APPT_BIZ_CODE "
            ...
            + "   and (b.apptstatus = '10' or b.apptstatus = '02')  "     //1、已申请但未确认  2、被退回的
...
*/
    ...
    dbGrid.setbuttons("查看贷款=loanQuery,查看抵押=query,抵押预约取消=batchEdit,moveFirst,prevPage,nextPage,moveLast");
%>
