...
<head>
    ...
    <script language="javascript" src="paperStlRtnList.js"></script>
...
<%
    ...
    String sql = "select a.nbxh,b.MORTECENTERCD,"
            ...
            + " a.loanid = b.loanid and b.mortstatus='" + CcbLoanConst.MORT_FLOW_DATA_SIGNIN + "'  "
...
//            + " and b.MORTECENTERCD in (select mortecentercd from ln_morttype where typeflag='0' and deptid='" + deptId + "') ";
    ...
    dbGrid.setWhereStr(" and a.bankid in(select deptid from ptdept start with deptid='" + omgr.getOperator().getDeptid() +
            "' connect by prior deptid=parentdeptid) order by b.mortecentercd, a.bankid, b.mortid ");
//    dbGrid.setWhereStr("  order by b.mortecentercd, a.bankid, b.mortid ");
    ...
    dbGrid.setbuttons("导出excel=excel,查看贷款=loanQuery,查看抵押=query,快递回证=editRecord,批量快递回证=batchEdit,moveFirst,prevPage,nextPage,moveLast");
%>
