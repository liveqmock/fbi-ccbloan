...
<head>
    ...
    <script language="javascript" src="paperStlRtnEdit.js"></script>
</head>
        ...
        <fieldset>
            ...
            <table width="100%" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="30%" class="data_input"><input name="EXPRESSRTNDATE" type="text" id="EXPRESSRTNDATE"
                ...
                <tr>
                    ...
                    <td width="30%" colspan="3" class="data_input"><textarea rows="3" style="width:96.4%"
                                                                             id="EXPRESSNOTE"
