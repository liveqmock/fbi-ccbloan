...
<head>
    ...
    <script language="javascript" src="dataSigninList.js"></script>
...
<%
    ...
    String sql = "select a.nbxh,b.MORTECENTERCD,"
            ...
            + "a.cust_name,a.RT_ORIG_LOAN_AMT,b.RELEASECONDCD,b.mortid,b.mortdate,b.BOXID,b.EXPRESSENDSDATE,b.recVersion,b.loanid"
    ...
    dbGrid.setField("快递发出日期", "center", "8", "EXPRESSENDSDATE", "true", "0");
    ...
    dbGrid.setbuttons("导出excel=excel,查看贷款=loanQuery,查看抵押=query,资料签收=editRecord,批量资料签收=batchEdit,moveFirst,prevPage,nextPage,moveLast");
%>
