...
<head>
    ...
    <script language="javascript" src="dataSigninEdit.js"></script>
</head>
<body bgcolor="#ffffff" onLoad="formInit();"  class="Bodydefault" >
<div id="container"> <br>
    <form id="editForm" name="editForm" >
        <fieldset >
            <legend>快递资料签收</legend>
            <table width="100%"  cellspacing="0" border="0">
                ...
                <tr>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding">资料签收日期</td>
                    <td width="30%" class="data_input"><input  name="EXP_DATA_SIGNIN_DATE"  type="text" id="EXP_DATA_SIGNIN_DATE"  style="width:90%" onClick="WdatePicker()" fieldType="date" isNull="false">
                        <span class="red_star">*</span></td>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding"></td>
                    <td width="30%" class="data_input"> </td>
                </tr>
                <tr>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding">资料签收备注</td>
                    <td width="30%" colspan="3" class="data_input"><textarea rows="3" style="width:96.4%" id="EXP_DATA_SIGNIN_REMARK" textLength="500"></textarea>
                    </td>
                </tr>
                <tr>
