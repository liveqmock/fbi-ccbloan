...
//    dbGrid.setField("交易中心", "dropdown", "10", "MORTECENTERCD", "true", "MORTECENTERCD");
    ...
    dbGrid.setField("贷款金额(万)", "money", "15", "loanamt", "true", "0");
    dbGrid.setField("保证金比例", "money", "15", "assuamtpercent", "true", "0");
    dbGrid.setField("应交保证金(万)", "money", "15", "amttmp", "true", "0");
    dbGrid.setField("保证金账号", "center", "20", "assuamt", "true", "0");
    dbGrid.setField("保证金账户余额(万)", "money", "15", "assuacctbal", "true", "0");
    dbGrid.setField("欠交保证金(万)", "money", "15", "oweassu", "true", "0");
