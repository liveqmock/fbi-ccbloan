    ...
    <table width="100%" cellspacing="0" border="0">
      ...
      <tr>
        ...
        <td width="30%"  class="data_input"><%
          ...
          <td width="30%" class="data_input"><input type="text" id="documentid" name="documentid" style="width:60%"
                                                    textLength="30">
              <input name="newDocId" type="button" id="button" onClick="newDocId_Click(document.queryForm)"  value="新编号">
