    ...
    <form id="editForm" name="editForm">
        <fieldset style="margin-top: 20px">
            ...
            <table width="100%" cellspacing="0" border="0">
                ...
                <tr>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款清退取证日期</td>
                    <td width="30%"  class="data_input"><input name="CLRPAPERDATE" type="text"
                                                                          id="CLRPAPERDATE" style="width:90%"
                                                                          onClick="WdatePicker()" fieldType="date"
                                                                          isNull="false">
                        <span class="red_star">*</span></td>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款清退取证原因</td>
                    <td width="30%" class="data_input"><%
                        ZtSelect zs = new ZtSelect("CLRREASONCD", "CLRREASONCD", "1");
                ...
                <tr>
                    <td width="20%" nowrap="nowrap" class="lbl_right_padding">清退原因说明</td>
                    <td width="30%" colspan="3" class="data_input"><textarea name="CLRREASONREMARK" rows="2" id="CLRREASONREMARK"
                                                                             value=""
                                                                             style="width:96.4%" textLength="100"></textarea>
                    </td>
                </tr>
                <tr>
