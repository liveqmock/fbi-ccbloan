 ...
 * 等级评定
 */
function creditraTable_levelRating_click() {
    // 增加系统锁检查
    if (getSysLockStatus() == "1") {
        alert(MSG_SYSLOCK);
        return;
    ...
    var ret = dialog("/UI/ccb/loan/creditrating/pscoredetailEdit.jsp?creditratingno=" + creditratingno + "&doType=edit", arg, sfeature);
    if (ret == "1") {
