...
<%
    ...
    dbGrid.setField("客户号", "center", "9", "custno", "false", "-1");
    ...
    dbGrid.setField("终评得分", "number", "5", "finscore", "true", "0");
    ...
    dbGrid.setbuttons("导出Excel=excel,资信评定=creditRating,moveFirst,prevPage,nextPage,moveLast");
%>
