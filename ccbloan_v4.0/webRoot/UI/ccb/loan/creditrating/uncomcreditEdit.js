...
function formInit() {
    ...
    document.getElementById("judgelevel2").value = document.getElementById("judgelevel").value;
    var appendNo = document.getElementById("appendNo").value;
    if (appendNo.length > 4) {
        document.getElementById("creditratingno").value = appendNo;
    }
...
function saveClick() {
    ...
    if (operation == "add") {
        retxml = createExecuteform(editForm, "insert", "crdt01", "addUncomcredit");
    } else if (operation == "append") {
        retxml = createExecuteform(editForm, "insert", "crdt01", "appendUncomcredit");
    } else if (operation == "edit") {
        retxml = createExecuteform(editForm, "update", "crdt01", "editUncomcredit");
    }  else if (operation == "check") {
        retxml = createExecuteform(editForm, "update", "crdt01", "uncomcreditCheck");
    }
