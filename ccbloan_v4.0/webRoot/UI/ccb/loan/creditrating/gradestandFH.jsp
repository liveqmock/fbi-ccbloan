...
<fieldset>
    <legend>操作</legend>
    <button id="outputReportFH"
            onclick="window.open('${pageContext.request.contextPath}/servlet/FHExcelServlet?custno=<%=custno%>' + '&iniLevel='+document.getElementById('inilevel').value + '&addScore='+ document.getElementById('addScore').value+'&creditratingno=<%=creditratingno%>',null,null);">
        输出报表
    </button>
</fieldset>
</body>
