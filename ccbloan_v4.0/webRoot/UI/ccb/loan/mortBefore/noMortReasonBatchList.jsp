...
<head>
    ...
    <script language="javascript" src="noMortReasonBatchList.js"></script>
...
<%
    ...
    String sql = "select a.nbxh, b.mortecentercd, (select deptname from ptdept where deptid=a.bankid) as deptname," +
            ...
            + " a.CUST_OPEN_DT, c.proj_name_abbr,b.recVersion "
    ...
    dbGrid.setField("合作项目简称", "center", "12", "proj_name_abbr", "true", "0");
    dbGrid.setField("版本号", "center", "0", "recVersion", "false", "0");
    dbGrid.setWhereStr(" and a.bankid in(select deptid from ptdept start with deptid='" + omgr.getOperator().getDeptid() + "' connect by prior deptid=parentdeptid)  order by  b.mortdate desc,b.mortecentercd, a.bankid, b.mortid ");

    dbGrid.setpagesize(30);
    dbGrid.setdataPilotID("datapilot");
    dbGrid.setCheck(true);
    dbGrid.setbuttons("导出Excel=excel,查看贷款=loanQuery,查看抵押=query,原因批量登记=BatchEditRecord,moveFirst,prevPage,nextPage,moveLast");
%>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            ...
            <tr height="20">
                ...
                <td width="30%" nowrap="nowrap" class="data_input">
                    <%
                        ZtSelect zs1 = new ZtSelect("RELEASECONDCD", "RELEASECONDCD", "");
                        zs1.addAttr("style", "width: 90%");
                        zs1.addAttr("fieldType", "text");
                        zs1.addOption("", "");
                        zs1.addAttr("isNull", "false");
                        out.print(zs1);
                    %>
                </td>
