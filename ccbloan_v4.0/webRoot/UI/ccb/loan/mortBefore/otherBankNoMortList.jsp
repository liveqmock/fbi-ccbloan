...
<%
    ...
    String sql = "select b.mortecentercd, "
            ...
            + " a.loanid,a.cust_name,a.RT_ORIG_LOAN_AMT,b.mortid,b.mortdate,b.SENDFLAG,b.RPTMORTDATE,a.nbxh,c.PROJ_NAME,c.bankflag "
    ...
    dbGrid.setField("开发贷种类", "dropdown", "10", "bankflag", "true", "BANKFLAG");
//    dbGrid.setWhereStr(" order by a.cust_py asc ");
    ...
    dbGrid.setbuttons("导出Excel=excel,查看贷款=loanQuery,查看抵押=query,不可报登记=editRecord,moveFirst,prevPage,nextPage,moveLast");
%>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            <tr height="20">
                ...
                <td width="20%" class="data_input"><input type="text" id="FLOWSN" name="FLOWSN" value="" style="width:96% ">
                </td>
                ...
                <td width="10%" nowrap="nowrap" class="data_input">
                    <%
