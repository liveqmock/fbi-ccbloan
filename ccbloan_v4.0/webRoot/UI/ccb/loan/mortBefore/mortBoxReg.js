...
//    }
    ...
    var ret = dialog("mortBoxEdit.jsp?clientNames=" + clientNames + "&strMortid="+ strMortid +"&recVersion="+recVersion+"&doType=add", arg, sfeature);
...
//    }
    ...
    var ret = dialog("mortBoxEdit.jsp?clientNames=" + clientNames + "&strMortid="+ strMortid +"&recVersion="+recVersion+"&doType=batchadd", arg, sfeature);
...
function loanRegistedTab_expExcel_click() {
    ...
    document.getElementById("queryForm").action = "/UI/ccb/loan/rpt/basicReport.jsp";
