...
<head>
    ...
    <script language="javascript" src="otherBankBoxReg.js"></script>
...
//    dbGrid.setWhereStr(" order by a.cust_py asc ");
    dbGrid.setWhereStr(" and a.bankid in(select deptid from ptdept start with deptid='" + omgr.getOperator().getDeptid() +
            "' connect by prior deptid=parentdeptid) order by b.mortecentercd, a.bankid,c.proj_name, b.mortid ");
    dbGrid.setpagesize(30);
    dbGrid.setdataPilotID("datapilot");
    dbGrid.setCheck(true);
    dbGrid.setbuttons("导出excel=excel,查看贷款=loanQuery,查看抵押=query,库柜登记=batchEdit,moveFirst,prevPage,nextPage,moveLast");
%>
