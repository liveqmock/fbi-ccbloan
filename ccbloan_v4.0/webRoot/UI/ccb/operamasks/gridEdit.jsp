...
<%
    ...
    if (request.getParameter("flowsn") != null)
        flowsn = request.getParameter("flowsn");
...
<tr>
    ...
    <td width="30%" class="data_input"><input type="text" id="flowsn" name="flowsn" value="<%=flowsn%>"
                                              style="width:90% "></td>
    <td width="20%" nowrap="nowrap" class="lbl_right_padding">借款人</td>
    <td width="30%" class="data_input"><input type="text" id="cust_name" name="cust_name" value=""
                                              style="width:90%"></td>
</tr>
<tr>
    <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款金额</td>
    <td width="30%" class="data_input"><input name="rt_orig_loan_amt" type="text" id="rt_orig_loan_amt"
                                              style="width:90%" value=""></td>
    <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款期限</td>
    <td width="30%" class="data_input"><input name="rt_term_incr" type="text" id="rt_term_incr"
                                              style="width:90%" value=""></td>
</tr>
</table>
</fieldset>
