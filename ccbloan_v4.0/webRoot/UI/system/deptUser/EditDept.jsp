        ...
        <table align="center" valign="center" width="100%">
          <tr>
            ...
            <td width="30%" colspan="3" class="data_input">
              <input class="text" id="deptname" style="width: 96.5%" fieldName="deptname" isNull="false" textLength="100" >
            </td>
            
          </tr>
          <tr>
            <td width="20%" class="lbl_right_padding">机构代号 </td>
            <td width="30%"  class="data_input">
              <input class="text" id="deptid" style="width: 90%" fieldName="deptid" textLength="100" isNull="false" >
            </td>
            <td width="20%" class="lbl_right_padding">上级机构代号 </td>
            <td width="30%"   class="data_input">
              <input class="text" id="parentdeptid" style="width:90%" fieldName="parentdeptid" textLength="100" isNull="false" >
            </td>
          </tr>
          <tr>
            ...
            <td width="20%" class="lbl_right_padding">机构报表分类</td>
            <td width="30%" class="data_input"><%
                  ZtSelect zs = new ZtSelect("FILLSTR20", "BANKRPTCLASS", "");
