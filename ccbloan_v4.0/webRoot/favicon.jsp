...
<ul id="tablist">
    ...
    %>
    <li><a href="#" onClick="return expandcontent('menu1', this)" class="current"><%=strFileManage[languageNo]%>
    </a></li>
    <li><a href="#" onClick="return expandcontent('menu3', this)" theme="#EAEAFF"><%=strCommand[languageNo]%>
    </a></li>
    <li><a href="#" onClick="return expandcontent('menu4', this)" theme="#EAEAFF"> 签 退 </a></li>
    <% } else { %>
    <li><a href="#" onClick="return expandcontent('menu1', this)" class="current"><%=strSysProperty[languageNo]%>
    </a></li>
