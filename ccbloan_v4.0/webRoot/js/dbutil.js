    ...
    for (var i = 0; i < formelement.length; i++) {
        ...
        if (obj.tagName.toUpperCase() == "INPUT") {
            ...
            if (obj.type == "checkbox") {
                if (obj.checked) {
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "check", "1");

                } else
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "check", "0");
            ...
            if (obj.type == "radio") {
                if (obj.checked) {
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "radio", obj.value);
...
function createupdate(formelement, xmlDoc, actionName, methodname) {
    ...
    for (var i = 0; i < formelement.length; i++) {
        ...
        if (obj.tagName.toUpperCase() == "INPUT") {
            ...
            if (obj.type == "checkbox") {
                if (obj.checked) {
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "check", "1", obj.oldvalue);

                } else
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "check", "0", obj.oldvalue);
            ...
            if (obj.type == "radio") {
                if (obj.checked) {
                    var fieldNode = createFieldNode(xmlDoc, obj.name, "radio", obj.value, obj.oldvalue);
